...
const Home = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center p-6">
            <div className="flex flex-col items-center justify-center p-6 mb-6 w-full max-w-md">
                {publicKey ? (
                    <div className="text-center">
                        ...
                        <div className="grid grid-cols-1 gap-4 w-full max-w-md py-12">
                <button
                ...
                <button
                    className="flex items-center justify-center bg-orange-500 text-white p-4 rounded-lg shadow-md hover:bg-orange-600"
                ...
                >
                    ...
                    <div className="text-center">
                        <h1 className="text-2xl font-semibold mb-5">Please connect your wallet</h1>
                        <WalletMultiButton />
                    </div>
                )}
            </div>
